...
- [ ] Read `docs/plans/dispute_agent_overview.md` and `docs/plans/dispute_agent_phase1.md` in full
- [ ] Read `packages/backend/src/services/dispute-pipeline.ts` in full
- [ ] Read `packages/backend/src/services/signals-query.ts` in full
- [ ] Read `packages/backend/src/services/case-api.ts` in full
- [ ] Read `packages/backend/src/prompts/dispute-planner-v1.md` in full
- [ ] Read `packages/frontend/src/components/rubric-tester/ResultsTable.tsx` in full
- [ ] Produce a brief inline comment listing: (a) what matches the spec, (b) what is missing or wrong
- [ ] Mark completed
